    ...
    render()
    {
        return(
            <div className="search_box_input">
                <input type="search" value={this.state.searchValue} onChange={this.handleChangeSearchValue.bind(this)} placeholder="Cauta titlu, autor sau editura"/>
                <span className="search_box_btn" onClick={this.handleSubmit.bind(this)}>
